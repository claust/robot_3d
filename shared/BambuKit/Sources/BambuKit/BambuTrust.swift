...
/// (Contents/Resources/cert/printer.cer). The printer's TLS certificate
/// chains to these (leaf, CN = printer serial, signed by a "BBL Device CA"
/// intermediate the printer presents, which is signed by one of these
/// roots) — the same trust model Bambu Studio itself uses for LAN printers.
enum BambuTrust {
